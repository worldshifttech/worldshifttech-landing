...
industry: nonprofit
pain_points:
  - donor cancellations processed manually with no automated follow-up
  - failed payment notifications not triggering any recovery workflow
  - donation platform and email marketing tool completely disconnected
  - staff time spent on administrative donor management instead of mission work
...
tools_used:
  ...
  - Mailchimp
results:
  time_saved: 3-5 hours per week in donor management
  roi: Automated donor retention workflows that previously required manual monitoring
  payback_period: First month
headline: Built an automated donor retention system that catches cancellations and failed payments before they become lost donors.
story: >

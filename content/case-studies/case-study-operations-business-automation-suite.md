...
industry: operations
pain_points:
  - shipping container status tracked manually across spreadsheets
  - no visibility into live container location without logging into external system
  - QuickBooks and project management tool completely disconnected
  - payroll processing required manual time entry cleanup every month
  - support questions answered by humans instead of documented knowledge
...
story: >
  A family-owned operations business was managing a growing number of moving pieces with a lean team. Shipping containers were tracked by logging into an external system and manually updating a spreadsheet. Invoices created in QuickBooks had no connection to the project management system where the actual work lived. Every month, payroll required someone to manually clean up time tracking exports, flag outliers, and calculate totals by hand.

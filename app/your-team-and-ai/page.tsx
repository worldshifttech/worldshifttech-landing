  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 pt-16 pb-24">
        ...
        <p className="text-[#00205C] text-lg leading-relaxed max-w-2xl">
        ...
        <div className="mt-20 pt-12 border-t border-[#00205C]/[0.16]">
          ...
          <h2
            className="text-2xl sm:text-3xl font-light text-[#00205C] mb-8"
          >
            Two mistakes. Same source.
          </h2>
          <div className="max-w-3xl space-y-4 text-[#00205C] text-base leading-relaxed">
            <p>
        ...
        <div className="mt-20 pt-12 border-t border-[#00205C]/[0.16]">
          ...
          <div className="max-w-3xl">
            <p className="text-[#00205C] text-base leading-relaxed mb-8">
            ...
            <div className="space-y-6">
              <div>
                <strong className="block text-[#00205C] text-base mb-1">Sales.</strong>
                <p className="text-[#00205C] text-base leading-relaxed">Your team knows your customers&apos; names, what they bought last year, what&apos;s been going on in their life, and the emotional cues they carry into conversations and meetings. AI can&apos;t pick that up. Only human interaction can.</p>
              </div>
              <div>
                <strong className="block text-[#00205C] text-base mb-1">Creativity.</strong>
                <p className="text-[#00205C] text-base leading-relaxed">AI doesn&apos;t do well with creativity. It can take direction and surface suggestions, but true creativity comes from people with creative skills built through emotion and years spent learning their craft. The emotional and psychological understanding of what needs to be created will only ever be done properly by humans.</p>
              </div>
              <div>
                <strong className="block text-[#00205C] text-base mb-1">Relationships.</strong>
                <p className="text-[#00205C] text-base leading-relaxed">Vendors. Partners. Long-term clients. What keeps these people wanting to be a part of your business? Your vision is usually the people and processes they&apos;re interacting with. Most of that is led by humans, not bots.</p>
              </div>
              <div>
                <strong className="block text-[#00205C] text-base mb-1">Critical thinking.</strong>
                <p className="text-[#00205C] text-base leading-relaxed">Reading why a customer is upset before they say it. Understanding why a deal stalled when the surface reason doesn&apos;t add up. Knowing when a partner needs space and figuring out how to pivot. AI doesn&apos;t do this. People do.</p>
              </div>
            </div>
            <p className="text-[#00205C] text-base leading-relaxed mt-8">
        ...
        <div className="mt-20 pt-12 border-t border-[#00205C]/[0.16]">
          ...
          <div className="max-w-3xl space-y-6">
            <p className="text-[#00205C] text-base leading-relaxed">
        ...
        <div className="mt-20 pt-12 border-t border-[#00205C]/[0.16] text-center">
          <h2
            className="text-3xl sm:text-4xl font-light text-[#00205C] mb-6 max-w-2xl mx-auto"
          >
            Your team helped build everything you have.
          </h2>
          <div className="max-w-2xl mx-auto space-y-4 text-[#00205C] text-base leading-relaxed mb-12">
            <p>
      ...
      <footer className="border-t border-[#00205C]/[0.12] py-8 px-6">
        <div className="max-w-6xl mx-auto text-center text-navy/70 text-sm">

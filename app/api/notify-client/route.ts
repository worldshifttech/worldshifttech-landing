...
<body style="margin:0;padding:0;background-color:#00205C;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#00205C;padding:48px 24px;">
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#080C14;border-radius:16px;overflow:hidden;border:1px solid rgba(255,255,255,0.08);">
          <tr>
            <td style="padding:48px 40px 32px;">
              ...
              <h1 style="margin:0 0 24px;font-size:28px;font-weight:700;color:#F4F2EE;line-height:1.3;">"${title}" is ready to explore.</h1>
              <p style="margin:0 0 32px;font-size:16px;color:rgba(244,242,238,0.7);line-height:1.6;">Hi ${greeting},<br><br>Your project is live. Drew has reviewed and approved the build.</p>
              ...
              <p style="margin:0 0 40px;font-size:14px;color:rgba(244,242,238,0.5);line-height:1.6;">This is an early build. Reply to this email with any questions or feedback.</p>
              <div style="border-top:1px solid rgba(255,255,255,0.08);padding-top:32px;">
                <p style="margin:0 0 4px;font-size:14px;color:#F4F2EE;font-weight:600;">Drew Griffiths</p>
                <p style="margin:0 0 4px;font-size:13px;color:rgba(244,242,238,0.5);">World Shift Technologies</p>
